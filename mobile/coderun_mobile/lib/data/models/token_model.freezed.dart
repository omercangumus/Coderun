...
mixin _$TokenModel {
  ...
  @JsonKey(name: 'expires_in', defaultValue: 1800)
...
abstract class $TokenModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'expires_in', defaultValue: 1800) int expiresIn});
}
...
class _$TokenModelImpl implements _TokenModel {
  ...
  @override
  String toString() {
    return 'TokenModel(accessToken: $accessToken, refreshToken: $refreshToken, tokenType: $tokenType, expiresIn: $expiresIn)';
  }
...
abstract class _TokenModel implements TokenModel {
  const factory _TokenModel(
      ...
      @JsonKey(name: 'expires_in', defaultValue: 1800)
      required final int expiresIn}) = _$TokenModelImpl;
